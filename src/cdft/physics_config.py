"""Shim: the canonical module is ``physics_config.py`` at the repository root (D-57).

Kept so that ``cdft.physics_config`` -- the import path every test, script and gate uses -- keeps working
...
import physics_config as _canonical
